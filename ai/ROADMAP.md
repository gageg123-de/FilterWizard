...
- Published 2026-09-02: controlled filter-size expansion added 16x24x1, 18x20x1, and 24x24x1 after real-world availability, first-party sizing-pattern, distinct-utility, retailer-path, and thin-page review. No size hub was added; reconsider one when contextual related links can no longer keep every size guide discoverable within a small number of useful clicks or when GSC shows a stable cluster that needs a consolidated landing page. At that time, article #34 was deferred pending fresher evidence and the furnace-short-cycling page was left unchanged for observation; article #34 was subsequently selected and published on 2026-09-16 as recorded above.
