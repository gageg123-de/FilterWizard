...
The sitemap contains 54 indexable URLs: the homepage, blog index, 39 blog articles, nine size guides, and four legal pages. The 50 non-legal content pages are the graph-analysis set. The homepage owns the Filter Finder and product-entry intent; the blog index owns guide discovery rather than a substantive filter question.
